...
function App() {
  ...
  return (
    <>
      <div className="bg-[rgb(18,18,18)] text-[#fff] h-[100vh] w-[100%] flex flex-col items-center">
        ...
        <div className="input-field">
          ...
          <button className="block px-[30px] rounded-[100px] h-[50px] w-[500px] mt-[30px] hover:bg-[url('/public/icon.svg')] hover:bg-center hover:bg-no-repeat hover:bg-cover">
            Generate QR Code
        ...
        <footer className="absolute bottom-0 w-[100%] text-center text-[#808080] font-metropolis border-t border-[#808080] py-[0px]">
