    ...
    return (
        <div className="input-field flex flex-col items-center">
            ...
            <button
                ...
                className="block px-6 rounded-full h-[50px] w-full max-w-[500px] mt-4 hover:bg-[url('/public/icon.svg')] 
    hover:bg-center hover:bg-no-repeat hover:bg-cover text-white"
            >
